...
export default function LinksPage() {
        ...
        const [allLinks, setAll]=useState([]);
...
const handleSearch = (e) => {
  ...
  const filtered = allLinks.filter((link) =>
    link.original.toLowerCase().includes(Currentval.toLowerCase())
  );

  setlinks(filtered.length > 0 ? filtered : allLinks);
};
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans p-6 md:p-10 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            type="text"
            placeholder="Search links, destinations..."
